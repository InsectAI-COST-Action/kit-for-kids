...
- **Children as investigators:** build, observe, test, and interpret.
- **Ecology first:** connect activities to real insects, habitats, and behaviour.
- **Modular and reusable:** adapt the kit for different experiments, lessons, and settings.
- **Low-cost and practical:** robust, portable, and suitable for ordinary classrooms.
- **Open and accessible:** share designs and resources so makerspaces and educators can replicate and adapt them.
