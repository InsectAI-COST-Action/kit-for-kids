...
(() => {
  ...
  const translations = {
    en: {
      ...
      'analysisModal.antai.label': 'AntAI – Beta \u{1F41C}',
      'analysisModal.antai.hint': 'Fast ant helper — trained on our own camera pictures. It checks each whole picture once.',
      ...
      'analysisModal.choiceNoteDefault': 'AntAI - Beta is selected: it only looks for ants, and its clues can still be wrong.',
      ...
      'demo.cardStatusDefault': 'Press Load camera card, then choose this demo folder in the next window.',
      ...
      'demo.analysisCardStatusDefault': 'Press Load camera card, then choose this demo folder in the next window. The browser can read the pictures and AI helper, but never change them.',
    },
    es: {
      ...
      'analysisModal.antai.label': 'AntAI – Beta \u{1F41C}',
      'analysisModal.antai.hint': 'Ayudante rápido de hormigas — entrenado con nuestras propias fotos de cámara. Revisa cada foto completa una vez.',
      ...
      'analysisModal.choiceNoteDefault': 'AntAI - Beta está seleccionado: solo busca hormigas, y sus pistas todavía pueden estar equivocadas.',
      ...
      'demo.cardStatusDefault': 'Pulsa Cargar tarjeta de la cámara, y elige esta carpeta de demostración en la siguiente ventana.',
      ...
      'demo.analysisCardStatusDefault': 'Pulsa Cargar tarjeta de la cámara, y elige esta carpeta de demostración en la siguiente ventana. El navegador puede leer las fotos y el ayudante de IA, pero nunca los cambia.',
    },
  };
