...
| `antai-test.onnx` | AntAI - Test, a one-class ant detector sourced pre-trained from the published `kit-for-kids` monorepo (18 September 2026, replacing AntAI - Beta). | Project's own model; no third-party redistribution question. |
