...
| Preparing the Barcelona show-and-tell | [Barcelona demo runbook](barcelona-demo.md) | Working source for the printable demo-day guide; what's built, what's missing, outstanding blockers. |
...
The current FlatBug Nano and AntAI - Test routes are browser prototypes only. It must be described as a **possible-insect prediction**, not species identification or a validated detection result.
